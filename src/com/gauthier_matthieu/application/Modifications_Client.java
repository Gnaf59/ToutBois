...
import com.gauthier_matthieu.application.Nouveau_Client;
 ...
 * @author glantoine
 */
public class Modifications_Client extends javax.swing.JFrame {

    public Modifications_Client() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Lb_Fenetre.setText("MODIFICATION CLIENTS");
        ...
        Bt_Valider.setMaximumSize(new java.awt.Dimension(75, 25));
        Bt_Valider.setMinimumSize(new java.awt.Dimension(75, 25));
        Bt_Valider.setPreferredSize(new java.awt.Dimension(120, 25));
        ...
        Bt_Annuler.setMaximumSize(new java.awt.Dimension(104, 25));
        Bt_Annuler.setMinimumSize(new java.awt.Dimension(104, 25));
        Bt_Annuler.setPreferredSize(new java.awt.Dimension(120, 25));
        ...
        Bt_Aide.setPreferredSize(new java.awt.Dimension(120, 25));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(Bt_Annuler, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void Bt_ValiderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Bt_ValiderActionPerformed
        try {
            ...
            if ("".equals(TF_Complement.getText())) {
            ...
            if ("".equals(TF_Societe.getText()) || "".equals(TF_Siret.getText()) || "".equals(TF_NumRue.getText()) || "".equals(TF_Rue.getText()) || "".equals(TF_Ville.getText()) || "".equals(TF_codePostal.getText()) || "".equals(TF_Complement.getText()) || "".equals(TF_NomContact.getText()) || "".equals(TF_PrenomContact.getText())) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Modifications_Client().pack();
                new Modifications_Client().setLocationRelativeTo(null);
                new Modifications_Client().setVisible(true);
